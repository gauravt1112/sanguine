...
if(!empty($submit))
{
	...
	<td width="70%" class="contact-text-form">'.$_REQUEST['signup'].'</td>
	</tr>
	</table>';
	$message .= '</body></html>';
	//End Html Page Here
	...
	$mail->Host = 'sanguineadvisory.com';	// Specify main and backup SMTP servers
	$mail->SMTPAuth = true;	// Enable SMTP authentication
	$mail->Username = 'sanguineadvisory';	// SMTP username
	$mail->Password = 'Makeinindia123';	// SMTP password
	...
	$mail->FromName = ''.$_REQUEST['signup'];	//Any Name Can be put here

	$mail->addAddress('sanguinecontact@gmail.com');	// Add a recipient
	//$mail->addAddress('saloni@togglehead.in');		// Name is optional
	$mail->addCC('gaurav@togglehead.in');
	$mail->addCC('saloni@togglehead.in');
	//Looping Files Here
	...
	$mail->Subject = 'Email From Sanguine Website';
	$mail->Body = $message;
